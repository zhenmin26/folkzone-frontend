...
describe("test article", () => {
  ...
  it("should add articles when adding a follower", () => {
    // console.log(userReducer({initState, friendUserIds: [1,2,3]}, {type: "addFriend", data: 5}))
    expect(userReducer({initState, friendUserIds: [1,2,3]}, {type: "addFriend", data: 5}).friendUserIds).toEqual([1,2,3,5]);
  });

  it("should remove articles when removing a follower", () => {
    expect(userReducer({initState, friendUserIds: [1,2,3,5]}, {type: "removeFriend", data: 5}).friendUserIds).toEqual([1,2,3]);
  });
});
